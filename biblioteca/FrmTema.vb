...
Public Class FrmTema
    ...
    Const spExploracion = "Tipo de Tema: Exploración de registros"
    Const spNuevo = "Tipo de Tema: Nuevo Registro"
    Const spModificacion = "Tipo de Tema: Modificación del Registro"
...
#End Region
    ...
    Private Sub EnlazaControles()
        ...
        Me.txtCodigo.DataBindings.Add("Text", DataSet_Master, "Tema.Cod_Tema")
        Me.txtNombres.DataBindings.Add("Text", DataSet_Master, "Tema.Descripcion")
    End Sub
    ...
    Private Sub FrmTipoLector_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TableName = "Tema"
        SQLAdapter_Master = New SqlDataAdapter("SELECT * FROM Tema", ModConexion.Conexion)
    ...
    Private Function ActualizarBaseDeDatos(ByVal IsInsercion As Boolean) As Integer
        ...
        oCNN.Open()
        If IsInsercion Then
            oCMD = NewComando(oCNN, "InsertTema", CommandType.StoredProcedure)
            oPRM = NewParameter("Descripcion", True, SqlDbType.VarChar, 20, txtNombres.Text)
            oCMD.Parameters.Add(oPRM)
        Else
            oCMD = NewComando(oCNN, "ActualizarTema", CommandType.StoredProcedure)
            oPRM = NewParameter("CodTema", True, SqlDbType.Int, 4, txtCodigo.Text)
            oCMD.Parameters.Add(oPRM)
            oPRM = NewParameter("Descripcion", True, SqlDbType.VarChar, 20, txtNombres.Text)
            oCMD.Parameters.Add(oPRM)
        End If
    ...
    Private Sub GeneraCodigo()
        Dim cmd As New SqlCommand("select max(Cod_Tema)from Tema", ModConexion.Conexion)
        Dim strCodigo As String
        ModConexion.Conexion.Open()
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        strDato = InputBox("Ingrese Codigo de Tema", "Buscar")
        Call MueveCursorA("Cod_Tema", strDato, "Codigo de Tema no existe")
    End Sub
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If cod <> 0 Then
            Actualizar()
            Call MueveCursorA("Cod_Tema", Str(cod), "")
            Call ConfiguraControles(0)
        End If
    End Sub
